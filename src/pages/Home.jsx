...
const Home = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-900 via-black to-purple-900">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-purple-600 to-cyan-500 border-b-8 border-black">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="text-center">
            <h1 className="text-5xl md:text-7xl font-black text-white tracking-wider uppercase neon-glow mb-4">
              ...
              ENTERTAINMENT
              <br />
              <span className="text-yellow-400 drop-shadow-[0_0_20px_rgba(255,255,0,0.9)]">MADE RADICAL!</span>
            </h1>
            <p className="mt-6 max-w-2xl mx-auto text-xl font-bold text-white bg-black/30 px-6 py-4 border-4 border-yellow-400">
            ...
            <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className="bg-black/40 border-4 border-white p-6 retro-shadow transform hover:scale-105 transition-transform">
                  <div className="text-4xl md:text-5xl font-black text-yellow-400 neon-glow">
                    {stat.number}
                  </div>
      ...
      <section className="py-16 bg-gradient-to-br from-purple-900 to-black border-y-8 border-pink-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl md:text-5xl font-black text-center text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-yellow-400 to-cyan-500 uppercase mb-12 tracking-wider">
            POPULAR CATEGORIES
          </h2>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {genres.map((genre, index) => (
              ...
              >
                ...
                <p className="text-sm font-bold text-white mt-2 bg-black/30 px-3 py-1">{genre.count} ACTS</p>
              </Link>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-br from-black via-purple-900 to-black bg-zigzag">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 text-xl font-bold text-cyan-400 max-w-2xl mx-auto bg-black/40 px-6 py-3 border-4 border-cyan-400">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="text-center retro-card p-6 hover:scale-105 transition-transform">
                <div className="inline-flex items-center justify-center h-20 w-20 bg-gradient-to-br from-pink-500 to-purple-600 border-4 border-black mb-4">
      ...
      <section className="py-20 bg-gradient-to-br from-black via-purple-900 to-black">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-gradient-to-r from-pink-500 via-purple-600 to-cyan-500 border-8 border-black rounded-none overflow-hidden retro-shadow">
            <div className="p-8 md:p-12 text-center text-white">
              <Music className="h-20 w-20 mx-auto mb-6 text-yellow-400 drop-shadow-[0_0_20px_rgba(255,255,0,0.9)]" />
              <h2 className="text-4xl md:text-5xl font-black uppercase mb-6 neon-glow tracking-wider">
                ARE YOU A PERFORMER?
              </h2>
              <p className="text-xl font-bold text-white mb-8 max-w-2xl mx-auto bg-black/30 px-6 py-4 border-4 border-yellow-400">
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-center justify-center text-lg font-bold bg-black/20 px-6 py-3 border-2 border-white">
      ...
      {/* Final CTA */}
      <section className="py-20 bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-600 border-y-8 border-black text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-black uppercase mb-6 text-black neon-glow tracking-wider">
            READY TO BOOK AMAZING ENTERTAINMENT?
          </h2>
          <p className="text-xl font-black text-white mb-8 bg-black/30 px-6 py-4 border-4 border-black">
